            ...
            {isLoggedIn ? (
              <>
                <div className="hidden sm:flex flex-col items-end">
                  ...
                  <span className={`badge ${rolColor[user?.rol || ""] ?? "badge-teal"} mt-0.5`}>{user?.rol}</span>
                </div>
                ...
                <button
                  ...
                  className="inline-flex items-center justify-center gap-2 text-red-500 font-medium px-4 py-2 rounded-lg hover:bg-red-50 hover:text-red-600 transition-colors text-sm"
                >
